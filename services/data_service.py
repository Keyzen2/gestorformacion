...
class DataService:
    ...
    # =========================
    # ACCIONES FORMATIVAS - FUNCIONES AUXILIARES
    # =========================
    @st.cache_data(ttl=300)
    ...
    # =========================
    # FUNCIONES AUXILIARES PARA SERVICIOS MODULARES
    # =========================
    @st.cache_data(ttl=300)
    ...
    # =========================
    # TUTORES - CONSERVAR PARA FUTURO SERVICIO
    # =========================
    @st.cache_data(ttl=300)
    ...
    # TODO: Estas funciones se moverán a servicios especializados en futuras migraciones:
    # - get_tutores_completos() -> tutores_service.py
    # - get_documentos() -> documentos_service.py  
    # - get_documentos_completos() -> documentos_service.py
    # - search_participantes() -> mantener para compatibilidad con archivos no migrados
