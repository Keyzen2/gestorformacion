...
def main(supabase, session_state):
    ...
    anio_filtrado = st.selectbox("Filtrar por Año", options=anios)
    if not df_acciones.empty and anio_filtrado:
        df_acciones = df_acciones[df_acciones["fecha_inicio"].dt.year == anio_filtrado]
